        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              Professional Cleaning <span className=" text-green-300  ">Solutions</span>
            </h1>
            ...
            {services.map((service) => (
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6">
                  <service.icon className="w-7 h-7  text-green-300  " />
                </div>
      ...
      <section className="py-16 lg:py-24 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <span className="inline-block px-4 py-1.5 bg-primary/10  text-green-300   rounded-full text-sm font-medium mb-4">
              How It Works
            </span>
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              Simple <span className=" text-green-300  ">Process</span>
            </h2>
          </div>
            ...
            {process.map((item) => (
              <div key={item.step} className="relative">
                <div className="bg-background rounded-2xl p-6 border border-border h-full">
                  <div className="w-12 h-12 rounded-full bg-primary  text-green-300  -foreground flex items-center justify-center font-bold text-xl mb-4">
                    {item.step}
                  </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl lg:text-4xl font-bold  text-green-300  -foreground mb-4">
                Need Help Choosing the Right Products?
              </h2>
              <p className=" text-green-300  -foreground/90">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/contact">
                <Button
                  variant="outline"
                  size="xl"
                  className="border-primary-foreground  text-green-300  -foreground hover:bg-primary-foreground hover: text-green-300  "
                >
              ...
              <Link href="/products">
                <Button
                  variant="ghost"
                  size="xl"
                  className=" text-green-300  -foreground hover:bg-primary-foreground/10"
                >
                  Browse Products
